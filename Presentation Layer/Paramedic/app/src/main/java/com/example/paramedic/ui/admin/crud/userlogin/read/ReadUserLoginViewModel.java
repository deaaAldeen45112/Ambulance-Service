...
public class ReadUserLoginViewModel extends ViewModel {
    ...
    private  static  final String TAG="ReadUserLoginViewModel";

    @ViewModelInject
    ReadUserLoginViewModel(UserLoginRepository userLoginRepository){

...
public class ParamedicSelectionViewModel extends ViewModel {
    ...
    public static final String TAG = "ParaSelectionViewModel";
    ...
    @ViewModelInject
    public ParamedicSelectionViewModel(PatientRepository patientRepository,
...
//    }
    ...
    public void updateParamedicIdAndRequestStatusByRequestId(Request request){

        this.requestRepository.updateParamedicIdAndRequestStatusByRequestId(request)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(status -> {

                    Log.d(TAG, "updateParamedicIdAndRequestStatusByRequestId: "+status);
                },error->{
                    Log.d(TAG, "updateParamedicIdAndRequestStatusByRequestId: "+error);
                });

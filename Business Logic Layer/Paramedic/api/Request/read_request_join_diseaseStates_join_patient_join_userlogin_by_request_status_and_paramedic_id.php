...
if ($_SERVER['REQUEST_METHOD'] === 'GET') { 
  ...
  // Blog post query
  $result = $request->read_request_join_diseaseStates_join_patient_join_userlogin_by_request_status_and_paramedic_id();
  // Get row count
  $num = $result->rowCount();
  $posts_arr = array();
